...
function New() {
    ...
    var tab = '<button class="t5 tablinks" onclick="openCity(event,'+ nb_fen + ')">Projet ' + nb_fen + '</button>';
            ...
            '<div class="row">' +
                ...
                '<div class="column2">' +
                    '<div id="option-container">' +
                        '<input class="t7 form-control" type="text" placeholder="Rechercher" aria-label="Rechercher" style="margin: 0px 0px 5px 0px; width: 70%;">' +
                    '</div>' +
